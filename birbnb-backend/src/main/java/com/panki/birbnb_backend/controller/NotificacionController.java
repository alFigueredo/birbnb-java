...
public class NotificacionController {
	...
	@PutMapping(path = "/{notifId}/leer")
	public @ResponseBody Notificacion marcarComoLeida(@PathVariable Long notifId) {
		return notificacionService.marcarComoLeida(notifId);
	}
